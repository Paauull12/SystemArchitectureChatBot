package com.company.ultraworkflow;
...
public class UltraManager {
    ...
    public void processCompleteOrder(String userId, String paymentMethodId, String promoCode) {
        ...
        loggingService.log("Order processed for user: " + userId);
